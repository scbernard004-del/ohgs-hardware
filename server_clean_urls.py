    ...
    def do_POST(self):
        if self.path.startswith("/api/notify"):
            ...
            data = {
                "ok": True,
                "local": True,
                "message": "Local test accepted. Real email sending works after deploying to Vercel with SMTP environment variables."
            }
...
if __name__ == "__main__":
    ...
    print("Local /api/notify will return OK. Real emails work on Vercel after SMTP setup.")
